...
```
run_command: python .agents/scripts/kicad_fetch_part.py chercher "ESP32-C3-MINI"
run_command: python .agents/scripts/kicad_fetch_part.py copier "RF_Module:ESP32-C3-MINI-1"
```
...
```
run_command: python .agents/scripts/kicad_search.py footprint "SOIC-8"
run_command: python .agents/scripts/kicad_search.py symbol "ESP32"
```
...
```
run_command: python .agents/scripts/kicad_search.py --index
```
...
`.agents/scripts/kicad_fetch_part.py` recopie un symbole des librairies KiCad
...
```
python .agents/scripts/kicad_fetch_part.py chercher "<référence ou boîtier>"
python .agents/scripts/kicad_fetch_part.py copier "<Librairie>:<Nom>"
```

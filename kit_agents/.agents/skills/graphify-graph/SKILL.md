...
```
run_command: python .agents/scripts/graph_query.py stats
run_command: python .agents/scripts/graph_query.py find "authenticate"
run_command: python .agents/scripts/graph_query.py callers "valider_commande"
run_command: python .agents/scripts/graph_query.py callees "traiter_paiement"
run_command: python .agents/scripts/graph_query.py neighbors "Facture"
run_command: python .agents/scripts/graph_query.py path "api_commande" "base_donnees"
```

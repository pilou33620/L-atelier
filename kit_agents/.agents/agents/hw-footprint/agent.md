...
`python .agents/scripts/kicad_search.py --index`. Les librairies KiCad sont hors
...
```
run_command: python .agents/scripts/pcbparts.py disponible "<référence fabricant>"
run_command: python .agents/scripts/pcbparts.py installer "<référence fabricant>" --projet .
```
